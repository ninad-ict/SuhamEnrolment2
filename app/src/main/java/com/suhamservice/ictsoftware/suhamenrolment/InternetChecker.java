            ...
            try
            {
                ...
                {socket.close();
                    ...
                    try{
                        ...
                        if(params[0]=="GIRL")
                            builder=new Uri.Builder().appendQueryParameter("WHO",params[0]).appendQueryParameter("STATE",params[1]).appendQueryParameter("DISTRICT",params[2]).appendQueryParameter("FED_CODE",params[3]).appendQueryParameter("PANCHAYAT",params[4]).appendQueryParameter("FEDERATION",params[5]).appendQueryParameter("VILLAGE",params[6]).appendQueryParameter("ID",params[7]).appendQueryParameter("GNAME",params[8]).appendQueryParameter("MOTHER",params[9]).appendQueryParameter("FATHER",params[10]).appendQueryParameter("DOB",params[11]).appendQueryParameter("M_MEMBER",params[12]).appendQueryParameter("F_MEMBER",params[13]).appendQueryParameter("MARRIAGE_YEAR",params[14]).appendQueryParameter("EDUCATION",params[15]).appendQueryParameter("WORK",params[16]).appendQueryParameter("STUDY",params[17]).appendQueryParameter("YEAR_PUBERTY",params[18]).appendQueryParameter("HB",params[19]).appendQueryParameter("HEIGHT",params[20]).appendQueryParameter("WEIGHT",params[21]).appendQueryParameter("TIME",params[22]).appendQueryParameter("ADDMOD",params[23]).appendQueryParameter("GROUPNAME",params[24]).appendQueryParameter("GROUPTYPE",params[25]).appendQueryParameter("CONTACT",params[26]).appendQueryParameter("TRANS",params[27]).appendQueryParameter("EMPID",params[28]);

                        if(params[0]=="PREG")
                            builder=new Uri.Builder().appendQueryParameter("WHO",params[0]).appendQueryParameter("STATE",params[1]).appendQueryParameter("DISTRICT",params[2]).appendQueryParameter("FED_CODE",params[3]).appendQueryParameter("PANCHAYAT",params[4]).appendQueryParameter("FEDERATION",params[5]).appendQueryParameter("VILLAGE",params[6]).appendQueryParameter("ID",params[7]).appendQueryParameter("NAME",params[8]).appendQueryParameter("M_MEMBER",params[9]).appendQueryParameter("HUSBAND",params[10]).appendQueryParameter("H_MEMBER",params[11]).appendQueryParameter("DOB",params[12]).appendQueryParameter("EDUCATION",params[13]).appendQueryParameter("LMP",params[14]).appendQueryParameter("EDD",params[15]).appendQueryParameter("GRAVIDA",params[16]).appendQueryParameter("WHEN_REGISTERED",params[17]).appendQueryParameter("MONTH_PREGNANT",params[18]).appendQueryParameter("TIME",params[19]).appendQueryParameter("ADDMOD",params[20]).appendQueryParameter("CONTACT",params[21]).appendQueryParameter("TRANS",params[22]).appendQueryParameter("EMPID",params[23]);

                        if(params[0]=="DELL")
                            builder=new Uri.Builder().appendQueryParameter("WHO",params[0]).appendQueryParameter("STATE",params[1]).appendQueryParameter("DISTRICT",params[2]).appendQueryParameter("FED_CODE",params[3]).appendQueryParameter("PANCHAYAT",params[4]).appendQueryParameter("FEDERATION",params[5]).appendQueryParameter("VILLAGE",params[6]).appendQueryParameter("ID",params[7]).appendQueryParameter("NAME",params[8]).appendQueryParameter("M_MEMBER",params[9]).appendQueryParameter("HUSBAND",params[10]).appendQueryParameter("H_MEMBER",params[11]).appendQueryParameter("DOB",params[12]).appendQueryParameter("EDUCATION",params[13]).appendQueryParameter("PLACE",params[14]).appendQueryParameter("STATUS",params[15]).appendQueryParameter("COLOSTRUM",params[16]).appendQueryParameter("TWINS",params[17]).appendQueryParameter("OUTCOME",params[18]).appendQueryParameter("ABORTION_MONTH",params[19]).appendQueryParameter("DOD",params[20]).appendQueryParameter("GRAVIDA",params[21]).appendQueryParameter("TIME",params[22]).appendQueryParameter("ADDMOD",params[23]).appendQueryParameter("CONTACT",params[24]).appendQueryParameter("TRANS",params[25]).appendQueryParameter("EMPID",params[26]);
