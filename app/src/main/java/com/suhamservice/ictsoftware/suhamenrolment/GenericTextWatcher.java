...
public class GenericTextWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable s) {
        try {
            ...
            if (s.length() == 4 && !s.toString().substring(3, 4).equals("-") && Integer.parseInt(s.toString().substring(3, 4)) > 1) {
            ...
            } else if (editText.length() == 2 && BACK_PRESSED == false) {//Log.d(mess,""+editText.length());
                editText.setText(s + "-");
