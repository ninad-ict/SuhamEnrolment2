...
public class HomeExpandListAdapter extends BaseExpandableListAdapter {
    ...
    public HomeExpandListAdapter(Context context,List<String> ListHeader,HashMap<String,List<String>> ListDetail)
    {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.homelisttopic,null);
        ...
        TextView listTitleTextView=(TextView)convertView.findViewById(R.id.HomeTextViewTopic);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        {
            LayoutInflater layoutInflater=(LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView=layoutInflater.inflate(R.layout.homelistsubtopic,null);

        }

        TextView expandedlistTextView=(TextView) convertView.findViewById(R.id.HomeTextViewSubTopic);

        expandedlistTextView.setText(Html.fromHtml(expandedString));
